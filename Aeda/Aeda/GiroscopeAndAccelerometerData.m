...
- (NSString *)description{
    return [NSString stringWithFormat:@"r(%.2f,%.2f,%.2f)a(%.2f,%.2f,%.2f);",self.rotation.x,self.rotation.y,self.rotation.z,self.acceleration.x,self.acceleration.y,self.acceleration.z];
}
